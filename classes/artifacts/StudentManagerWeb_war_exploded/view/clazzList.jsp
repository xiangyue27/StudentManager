	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'info',title:'辅导员',width:100, 
 		        },
	 		]], 
	        toolbar: "#toolbar"
	    }); 
...
<body>
	...
	<c:if test="${userType == 1}">
		<div style="float: left;"><a id="add" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加班级</a></div>
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>辅导员:</td>
	    			<td>
	    			<input id="add_info" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="info"/>
	    			</td>
	    		</tr>
	    	</table>
	    </form>
    	...
    	<input type="hidden" id="edit-id" name="id">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>辅导员:</td>
	    				<td>
	    				<input id="edit_info" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="info" />
	    				</td>
	    		</tr>
	    	</table>
	    </form>
