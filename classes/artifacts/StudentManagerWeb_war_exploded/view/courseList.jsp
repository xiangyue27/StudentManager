	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				...
				{field:'info',title:'上课教室',width:200},
	 		]], 
	        toolbar: "#toolbar",
	  ...
	  //编辑课程信息
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_info").val('setValue',selectRow.info);
            			...
            			$.ajax({
							...
							success: function(msg){
								if(msg == "success"){
									...
									$.messager.alert("消息提醒","删除失败!请先将选择该课程的学生删除再进行此操作。","warning");
									return;
								}
							}
						});
...
<body>
	...
	<c:if test="${userType == 1|| userType == 3}">
		<div style="float: left;"><a id="add" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加课程</a></div>
		...
		<div style="margin-top: 3px;">
			...
			<a id="search-btn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-zoom-in',plain:true">搜索</a>
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>课程名称:</td>
	    			<td><input id="add_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="name" data-options="required:true, missingMessage:'请输入课程名称'" /></td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
	    			<td>上课时间:</td>
	    			<td><input id="add_course_date" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="course_date" data-options="required:true, missingMessage:'请输入授课时间'" /></td>
	    		</tr>
	    		<tr>
	    			<td>最多可选人数:</td>
	    			<td><input id="add_max_num" style="width: 200px; height: 30px;" class="easyui-numberbox" type="text" name="maxnum" data-options="min:0,precision:0,required:true, missingMessage:'请输入可选人数'" /></td>
	    		</tr>
	    		<tr>
	    			<td>上课教室:</td>
	    			<td>
						<input id="info" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="info" data-options="required:true, missingMessage:'请输入上课教室'" />
	    			</td>
	    		</tr>
	    	</table>
	    </form>
	...
	<div id="editDialog" style="padding: 10px">  
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>课程名称:</td>
	    			<td><input id="edit_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="name" data-options="required:true, missingMessage:'请输入课程名称'" /></td>
	    		</tr>
	    		<tr>
	    			<td style="width:40px">授课老师:</td>
	    			<td colspan="3">
	    		...
	    		<tr>
	    			<td>上课时间:</td>
	    			<td><input id="edit_course_date" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="course_date" data-options="required:true, missingMessage:'请输入授课时间'" /></td>
	    		</tr>
	    		<tr>
	    			<td>最多可选人数:</td>
	    			<td><input id="edit_max_num" style="width: 200px; height: 30px;" class="easyui-numberbox" type="text" name="max_num" data-options="min:0,precision:0,required:true, missingMessage:'请输入可选人数'" /></td>
	    		</tr>
	    		<tr>
	    			<td>上课教室:</td>
	    			<td>
					<input id="edit_info" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="info" data-options="required:true, missingMessage:'请输入上课教室'" />
	    			</td>
	    		</tr>
	    	</table>
	    </form>
