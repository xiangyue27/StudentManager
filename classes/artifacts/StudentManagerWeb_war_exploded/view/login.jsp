...
<title>登录界面|学生选课管理系统</title>
<meta name="keywords" content="学生选课管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 650px; padding: 0;">学生选课管理系统</h2>
</div>
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          <input class="input-text size-L" name="vcode" type="text" placeholder="Vcode" style="width: 200px;">
      ...
      <div class="mt-20 skin-minimal" style="text-align: center;">
		<div class="radio-box">
			...
			<label for="radio-1">学生端</label>
		</div>
		<div class="radio-box">
			<input type="radio" id="radio-3" name="type" value="3" />
			<label for="radio-2">教师端</label>
		</div>
		<div class="radio-box">
