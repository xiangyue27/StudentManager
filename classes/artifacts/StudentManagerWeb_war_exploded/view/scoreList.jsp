...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="import" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-book-add',plain:true">导入成绩</a></div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="float: left;"><a id="edit" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">修改</a></div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="float: left;"><a id="export" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-folder-up',plain:true">导出成绩单</a></div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_score" style="width: 200px; height: 30px;" class="easyui-numberbox" data-options="required:true,min:0,precision:1, missingMessage:'请填写正确的成绩'" name="score" />
	    			</td>
	    			<td style="width:80px"></td>
	    		</tr>
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td>
	    				<textarea id="add_remark" name="remark" style="width: 240px; height: 120px;" class="easyui-textbox" data-options="multiline:true" ></textarea>
	    			</td>
	    		</tr>
	    	</table>
	    </form>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td style="width:40px">成绩:</td>
	    			<td colspan="3">
	    				<input id="edit_score" style="width: 200px; height: 30px;" class="easyui-numberbox" data-options="required:true,min:0,precision:1, missingMessage:'请填写正确的成绩'" name="score" />
	    			</td>
	    			<td style="width:80px"></td>
	    		</tr>
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td>
	    				<textarea id="edit_remark" name="remark" style="width: 240px; height: 120px;" class="easyui-textbox" data-options="multiline:true" ></textarea>
	    			</td>
	    		</tr>
	    	</table>
	    </form>
