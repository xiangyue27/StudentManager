	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'clazz_id',title:'班级',width:200, 
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$.messager.alert("消息提醒","学号已存在!","warning");
										return;
									}
								}
							});
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="add" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加学生</a></div>
		...
		<div style="margin-left: 10px;margin-top:2px;" >班级：<input id="clazzList" class="easyui-textbox" name="clazz" />
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>学号:</td>
	    			<td><input id="add_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn" data-options="required:true, missingMessage:'请填写学号'" /></td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
	    			<td>
