	 ...
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"学生信息管理",
							"menus":[
									...
									{"menuid":"22","menuname":"成绩列表","icon":"icon-book-open","url":"ScoreServlet?method=toScoreListView"},
								]
						},
						...
						{"menuid":"6","icon":"","menuname":"课程信息管理",
							"menus":[
									...
									{"menuid":"62","menuname":"选课列表","icon":"icon-book-open","url":"SelectedCourseServlet?method=toSelectedCourseListView"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        background: url(/h-ui/images/email-pattern.png) #7f99be repeat-x center 50%;
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体">
        <span style="float:right; padding-right:20px;" class="head"><span style="color:black; font-weight:bold;">${user.name}&nbsp;</span>您好！&nbsp;&nbsp;&nbsp;<a href="LoginServlet?method=logout" id="loginOut">退出登录</a></span>
        <span style="padding-left:10px; font-size: 16px; ">学生选课管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">海南热带海洋学院 Hp</div>
    </div>
    <div region="west" hide="true" split="true" title="导航" style="width:180px;" id="west">
