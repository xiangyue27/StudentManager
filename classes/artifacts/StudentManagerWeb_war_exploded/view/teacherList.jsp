							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$.messager.alert("消息提醒","工号已存在!","warning");
										return;
									}
								}
							});
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="add" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加教师</a></div>
	...
	<div id="addDialog" style="padding: 10px;">  
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		...
	    		<tr>
	    			<td>工号:</td>
	    			<td colspan="4"><input id="add_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn" data-options="required:true, missingMessage:'请填写工号'" /></td>
	    		</tr>
	    		<tr>
	    			<td>性别:</td>
